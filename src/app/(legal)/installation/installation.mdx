...
1. Click [here](/chrome-1.1.0.zip) to download the extension as a .zip file.

## Step 2: Install the Extension

### 1. Open Google Chrome or Microsoft Edge on your computer.

![Microsoft Edge](/2-1.png "Microsoft Edge")
...
![Microsoft Edge Extensions Page](/2-2.png "Microsoft Edge Extensions Page")

### 4. Drag and drop the downloaded .zip file onto the Extensions page.

![Microsoft Edge Extensions Drag-and-Drop](/2-3.png "Microsoft Edge Extensions Drag-and-Drop")
...
![Reccomen.do Front Page](/3-1.png "Reccomen.do Front Page")

### 2. Provide the required information and complete the sign-up process.

![Reccomen.do Authentication using AuthUI](/3-2.png "Reccomen.do Authentication using AuthUI")
...
![Reccomen.do API Key setup](/4-1.png "Reccomen.do API Key setup")
...
![Reccomen.do Subscription Plans](/4-2.png "Reccomen.do Subscription Plans")
...
![Reccomen.do Prompt Before](/6-1.png "Reccomen.do Prompt Before")

### 3. After the search results appear, use the extension's prompt to get a choice recommendation.

![Reccomen.do Prompt After](/6-2.png "Reccomen.do Prompt After")

### 4. Each successful AI result decreases the recommendations usage by 1.

## Step 7: Refill Recommendations or Update Plan

### 1. If you have an active subscription, you can add extra recommendations.

![Reccomen.do Manage Subscription](/7-1.png "Reccomen.do Manage Subscription")

- Visit the extension's website and go to your profile page.
- Click "Add 50 extra recommendations" and follow the payment instructions.
